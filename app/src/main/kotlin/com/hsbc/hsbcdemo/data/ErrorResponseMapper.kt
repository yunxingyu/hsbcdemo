 ...
 */
object ErrorResponseMapper : ApiErrorModelMapper<HsbcErrorResponse> {
   ...
   */
  override fun map(apiErrorResponse: ApiResponse.Failure.Error<*>): HsbcErrorResponse {
    return HsbcErrorResponse(apiErrorResponse.statusCode.code, apiErrorResponse.message())
  }
}
